...
# tkinter.Label(grid_frame_1, text="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").grid(row=3, column=0)

# Gird 2 layout
tkinter.Label(grid_frame_2, text="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").grid(row=0, column=0)
